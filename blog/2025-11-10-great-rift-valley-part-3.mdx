...
"This is what is known in nature as 'fatal delusion.' In corporate settings, it is called 'reframing.'"_
...
"In nature, we call this 'prey animal deception'—the false signals used to avoid being eaten. In corporate environments, it is called 'executive reporting.'"\_
