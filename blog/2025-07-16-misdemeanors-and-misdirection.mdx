...
Digging out your seer stone, you simply start removing selections one at a time, until you find that if you simply clear _all fields_ you get an actual search result. That'd be a rather easy default...a blank form that returns a result, rather than a pre-populated form that returns errors.
